...
GATESET_OPT_MAP = [['cnot[0, 1]-d1-carrier-framechange'],
                   ...
                   ['cnot[0, 1]-d1-gauss0-t_final'],
                   ['cnot[0, 1]-d1-gauss1-amp'],
                   ['cnot[0, 1]-d1-gauss1-freq_offset'],
                   ['cnot[0, 1]-d1-gauss1-sigma'],
                   ['cnot[0, 1]-d1-gauss1-xy_angle'],
                   ['cnot[0, 1]-d1-gauss1-t_final'],
                   ['cnot[0, 1]-d1-gauss2-amp'],
                   ['cnot[0, 1]-d1-gauss2-freq_offset'],
                   ['cnot[0, 1]-d1-gauss2-sigma'],
                   ['cnot[0, 1]-d1-gauss2-xy_angle'],
                   ['cnot[0, 1]-d1-gauss2-t_final'],
                   ['cnot[0, 1]-d1-gauss3-amp'],
                   ['cnot[0, 1]-d1-gauss3-freq_offset'],
                   ['cnot[0, 1]-d1-gauss3-sigma'],
                   ['cnot[0, 1]-d1-gauss3-xy_angle'],
                   ['cnot[0, 1]-d1-gauss3-t_final'],
                   ['cnot[0, 1]-d1-gauss4-amp'],
                   ['cnot[0, 1]-d1-gauss4-freq_offset'],
                   ['cnot[0, 1]-d1-gauss4-sigma'],
                   ['cnot[0, 1]-d1-gauss4-xy_angle'],
                   ['cnot[0, 1]-d1-gauss4-t_final'],
                   ['cnot[0, 1]-d1-gauss5-amp'],
                   ['cnot[0, 1]-d1-gauss5-freq_offset'],
                   ['cnot[0, 1]-d1-gauss5-sigma'],
                   ['cnot[0, 1]-d1-gauss5-xy_angle'],
                   ['cnot[0, 1]-d1-gauss5-t_final'],
                   ['cnot[0, 1]-d1-gauss6-amp'],
                   ['cnot[0, 1]-d1-gauss6-freq_offset'],
                   ['cnot[0, 1]-d1-gauss6-sigma'],
                   ['cnot[0, 1]-d1-gauss6-xy_angle'],
                   ['cnot[0, 1]-d1-gauss6-t_final'],
                   ['cnot[0, 1]-d1-gauss7-amp'],
                   ['cnot[0, 1]-d1-gauss7-freq_offset'],
                   ['cnot[0, 1]-d1-gauss7-sigma'],
                   ['cnot[0, 1]-d1-gauss7-xy_angle'],
                   ['cnot[0, 1]-d1-gauss7-t_final'],
                   ['cnot[0, 1]-d1-gauss8-amp'],
                   ['cnot[0, 1]-d1-gauss8-freq_offset'],
                   ['cnot[0, 1]-d1-gauss8-sigma'],
                   ['cnot[0, 1]-d1-gauss8-xy_angle'],
                   ['cnot[0, 1]-d1-gauss8-t_final'],
                   ['cnot[0, 1]-d1-gauss9-amp'],
                   ['cnot[0, 1]-d1-gauss9-freq_offset'],
                   ['cnot[0, 1]-d1-gauss9-sigma'],
                   ['cnot[0, 1]-d1-gauss9-xy_angle'],
                   ['cnot[0, 1]-d1-gauss9-t_final'],
                   ['cnot[0, 1]-d1-flattop_gauss0-amp'],
                   ['cnot[0, 1]-d1-flattop_gauss0-freq_offset'],
                   ['cnot[0, 1]-d1-flattop_gauss0-sigma'],
                   ['cnot[0, 1]-d1-flattop_gauss0-risefall'],
                   ['cnot[0, 1]-d1-flattop_gauss0-xy_angle'],
                   ['cnot[0, 1]-d1-flattop_gauss0-t_final'],
                   ['cnot[0, 1]-d1-flattop_gauss1-amp'],
                   ['cnot[0, 1]-d1-flattop_gauss1-freq_offset'],
                   ['cnot[0, 1]-d1-flattop_gauss1-sigma'],
                   ['cnot[0, 1]-d1-flattop_gauss1-risefall'],
                   ['cnot[0, 1]-d1-flattop_gauss1-xy_angle'],
                   ['cnot[0, 1]-d1-flattop_gauss1-t_final'],
                   ['cnot[0, 1]-d1-flattop_gauss2-amp'],
                   ['cnot[0, 1]-d1-flattop_gauss2-freq_offset'],
                   ['cnot[0, 1]-d1-flattop_gauss2-sigma'],
                   ['cnot[0, 1]-d1-flattop_gauss2-risefall'],
                   ['cnot[0, 1]-d1-flattop_gauss2-xy_angle'],
                   ['cnot[0, 1]-d1-flattop_gauss2-t_final'],
                   ['cnot[0, 1]-d1-flattop_gauss3-amp'],
                   ['cnot[0, 1]-d1-flattop_gauss3-freq_offset'],
                   ['cnot[0, 1]-d1-flattop_gauss3-sigma'],
                   ['cnot[0, 1]-d1-flattop_gauss3-risefall'],
                   ['cnot[0, 1]-d1-flattop_gauss3-xy_angle'],
                   ['cnot[0, 1]-d1-flattop_gauss3-t_final'],
                   ['cnot[0, 1]-d1-flattop_gauss4-amp'],
                   ['cnot[0, 1]-d1-flattop_gauss4-freq_offset'],
                   ['cnot[0, 1]-d1-flattop_gauss4-sigma'],
                   ['cnot[0, 1]-d1-flattop_gauss4-risefall'],
                   ['cnot[0, 1]-d1-flattop_gauss4-xy_angle'],
                   ['cnot[0, 1]-d1-flattop_gauss4-t_final'],
                   ['cnot[0, 1]-d2-gauss0-amp'],
                   ['cnot[0, 1]-d2-gauss0-freq_offset'],
                   ['cnot[0, 1]-d2-gauss0-sigma'],
                   ['cnot[0, 1]-d2-gauss0-xy_angle'],
                   ['cnot[0, 1]-d2-gauss0-t_final'],
                   ['cnot[0, 1]-d2-gauss1-amp'],
                   ['cnot[0, 1]-d2-gauss1-freq_offset'],
                   ['cnot[0, 1]-d2-gauss1-sigma'],
                   ['cnot[0, 1]-d2-gauss1-xy_angle'],
                   ['cnot[0, 1]-d2-gauss1-t_final'],
                   ['cnot[0, 1]-d2-gauss2-amp'],
                   ['cnot[0, 1]-d2-gauss2-freq_offset'],
                   ['cnot[0, 1]-d2-gauss2-sigma'],
                   ['cnot[0, 1]-d2-gauss2-xy_angle'],
                   ['cnot[0, 1]-d2-gauss2-t_final'],
                   ['cnot[0, 1]-d2-gauss3-amp'],
                   ['cnot[0, 1]-d2-gauss3-freq_offset'],
                   ['cnot[0, 1]-d2-gauss3-sigma'],
                   ['cnot[0, 1]-d2-gauss3-xy_angle'],
                   ['cnot[0, 1]-d2-gauss3-t_final'],
                   ['cnot[0, 1]-d2-gauss4-amp'],
                   ['cnot[0, 1]-d2-gauss4-freq_offset'],
                   ['cnot[0, 1]-d2-gauss4-sigma'],
                   ['cnot[0, 1]-d2-gauss4-xy_angle'],
                   ['cnot[0, 1]-d2-gauss4-t_final'],
                   ['cnot[0, 1]-d2-gauss5-amp'],
                   ['cnot[0, 1]-d2-gauss5-freq_offset'],
                   ['cnot[0, 1]-d2-gauss5-sigma'],
                   ['cnot[0, 1]-d2-gauss5-xy_angle'],
                   ['cnot[0, 1]-d2-gauss5-t_final'],
                   ['cnot[0, 1]-d2-gauss6-amp'],
                   ['cnot[0, 1]-d2-gauss6-freq_offset'],
                   ['cnot[0, 1]-d2-gauss6-sigma'],
                   ['cnot[0, 1]-d2-gauss6-xy_angle'],
                   ['cnot[0, 1]-d2-gauss6-t_final'],
                   ['cnot[0, 1]-d2-gauss7-amp'],
                   ['cnot[0, 1]-d2-gauss7-freq_offset'],
                   ['cnot[0, 1]-d2-gauss7-sigma'],
                   ['cnot[0, 1]-d2-gauss7-xy_angle'],
                   ['cnot[0, 1]-d2-gauss7-t_final'],
                   ['cnot[0, 1]-d2-gauss8-amp'],
                   ['cnot[0, 1]-d2-gauss8-freq_offset'],
                   ['cnot[0, 1]-d2-gauss8-sigma'],
                   ['cnot[0, 1]-d2-gauss8-xy_angle'],
                   ['cnot[0, 1]-d2-gauss8-t_final'],
                   ['cnot[0, 1]-d2-gauss9-amp'],
                   ['cnot[0, 1]-d2-gauss9-freq_offset'],
                   ['cnot[0, 1]-d2-gauss9-sigma'],
                   ['cnot[0, 1]-d2-gauss9-xy_angle'],
                   ['cnot[0, 1]-d2-gauss9-t_final'],
                   ['cnot[0, 1]-d2-flattop_gauss0-amp'],
                   ['cnot[0, 1]-d2-flattop_gauss0-freq_offset'],
                   ['cnot[0, 1]-d2-flattop_gauss0-sigma'],
                   ['cnot[0, 1]-d2-flattop_gauss0-risefall'],
                   ['cnot[0, 1]-d2-flattop_gauss0-xy_angle'],
                   ['cnot[0, 1]-d2-flattop_gauss0-t_final'],
                   ['cnot[0, 1]-d2-flattop_gauss1-amp'],
                   ['cnot[0, 1]-d2-flattop_gauss1-freq_offset'],
                   ['cnot[0, 1]-d2-flattop_gauss1-sigma'],
                   ['cnot[0, 1]-d2-flattop_gauss1-risefall'],
                   ['cnot[0, 1]-d2-flattop_gauss1-xy_angle'],
                   ['cnot[0, 1]-d2-flattop_gauss1-t_final'],
                   ['cnot[0, 1]-d2-flattop_gauss2-amp'],
                   ['cnot[0, 1]-d2-flattop_gauss2-freq_offset'],
                   ['cnot[0, 1]-d2-flattop_gauss2-sigma'],
                   ['cnot[0, 1]-d2-flattop_gauss2-risefall'],
                   ['cnot[0, 1]-d2-flattop_gauss2-xy_angle'],
                   ['cnot[0, 1]-d2-flattop_gauss2-t_final'],
                   ['cnot[0, 1]-d2-flattop_gauss3-amp'],
                   ['cnot[0, 1]-d2-flattop_gauss3-freq_offset'],
                   ['cnot[0, 1]-d2-flattop_gauss3-sigma'],
                   ['cnot[0, 1]-d2-flattop_gauss3-risefall'],
                   ['cnot[0, 1]-d2-flattop_gauss3-xy_angle'],
                   ['cnot[0, 1]-d2-flattop_gauss3-t_final'],
                   ['cnot[0, 1]-d2-flattop_gauss4-amp'],
                   ['cnot[0, 1]-d2-flattop_gauss4-freq_offset'],
                   ['cnot[0, 1]-d2-flattop_gauss4-sigma'],
                   ['cnot[0, 1]-d2-flattop_gauss4-risefall'],
...
if __name__ == '__main__':
    ...
    while True:
        ...
        exp.write_config(f'flattop_gauss_mix_complex_sol_relaxation_reg_{reg_strength:.2e}.hjson')
